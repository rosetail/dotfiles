...
- physical volumes (pv) are devices or partitions which have been initialized into the lvm system
- volume groups (vg) are a pool of pvs
  - it is the lvm equivalent of an entire disk
- logical volumes (lv) are the lvm equivalent of partitions
